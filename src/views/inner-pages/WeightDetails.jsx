                    ...
                    <div className="col-xl-6 col-lg-6">
                      <div className="bamba__header-content ">
                        ...
                        <p>
                          ...
                          of. Yet bed any for travelling assistance indulgence
                          unpleasing. Not thoughts all exercise blessing.
                          Indulgence way everything joy alteration boisterous
                          the attachment. Party we years to order allow asked
                          of. asked of. Yet bed any for travelling assistance
                          ...
                          allow asked of. to order allow asked of. asked of. Yet
                          bed any for travelling assistance indulgence
                          unpleasing. Not thoughts all exercise blessing.
                          Indulgence way everything joy alteration boisterous
                          the attachment. Party we years to order allow asked
                          of.
                      ...
                      <hr
                        style={{ backgroundColor: "grey", marginTop: "50px" }}
                      />
                      <BoxingInfo />
                    </div>
                    <div className="col-xl-6 col-lg-6 p-5">
                      <div className="row ">
                        <img src={weightpic} alt="" className="" />
                      </div>
