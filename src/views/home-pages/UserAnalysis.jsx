            ...
            <div className="row ">
              <div className="col-xl-6 col-lg-6">
                <div className="text-lg-start">
                  <h2 style={{ fontSize: "24px" }}>A NEW GYM</h2>
                  <h2 className="main-title" style={{ fontSize: "24px" }}>
                    FOR A NEW TIME
                  </h2>
                </div>
                {/* /.title-style-three */}
              </div>
              <div className="col-xl-6 col-lg-6 fw-lighter lh-sm ">
                <p>
                  {/* todo FONT WEIGHT */}
                  ...
                  order allow asked of. thoughts all exercise blessing.
                  Indulgence way everything joy alteration boisterous the
                  attachment. Party we years to order allow asked of. asked of.
