                    ...
                    {PageContent.map((val, i) => (
                      <li key={i}>
                        <Link to={val.routerPath}>
                          <h3 style={{ padding: "12px" }}>-{val.name}</h3>
                        </Link>
                      </li>
                    ))}
                  </ul>
            ...
            <div className="row">
              <div className="col-lg-6 col-sm-6">
                <div className="row d-flex">
                  <div
                    className="col-lg-4 col-sm-4 mb-40 col-xs-4"
                    style={{ maxWidth: "30%" }}
                  >
                    <div className="logo">
                      <Link to="/">
                  ...
                  <div
                    className="col-lg-8 col-sm-8 mb-30 col-xs-8"
                    style={{ maxWidth: "65%" }}
                  >
                    <ul className="footer-nav-link style-none">
                      {PageContent.map((val, i) => (
                        <li key={i}>
                          <Link to={val.routerPath}>
                            <h4 style={{ padding: "12px" }}>{val.name}</h4>
                          </Link>
                        </li>
                      ))}
                    </ul>
