      ...
      <div className="mobile-menu-wrapper">
        ...
        <ProSidebar className={click ? "mobile-menu menu-open" : "mobile-menu"}>
          <SidebarHeader>
            <div className="mobile-logo">
              <Link to="/" className="d-block">
                <img src={bambaLogo} alt="" className="shapes shape-two" />
              </Link>
            </div>
          ...
          <SidebarContent className="d-flex flex-column justify-content-between">
            ...
            <div className="mx-auto mt-100 text-center px-3 w-100">
              <Link
                to="/booking"
                className="bg-white w-100 text-dark py-2 fw-bold "
              >
                BOOK
              </Link>
              ...
              <div className="flex-column pb-80">
                <div className="pt-4">
                  <p className="text-start" style={{ fontSize: "14px" }}>
                    ...
                    <span className="text-muted">
                      | Lützengatan 10 | 11520 Stockholm | Sweden
                    </span>
                  </p>
                </div>
                <hr />
                ...
                <div className="">
                  <p className="text-start" style={{ fontSize: "14px" }}>
                    Instagram <span className="text-muted">@bambagym</span> |
                    E-mail<span className="text-muted">info@bamba.se</span>
                  </p>
                </div>
              </div>
            </div>
