                ...
                switch (isShown) {
                  case 0:
                    if (activeUrl == -1) {
                      ...
                      return (
                        <img src={viewPic[activeUrl]} alt="" className="" />
                      );
                    }
                  case 1:
                ...
                if (activeUrl == -1 && isShown == 0) {
                  ...
                  return (
                    <div className="train-banner-text d-flex">
                      ...
                      <div className="">
                        Calorie-torching workouts that will
                        <br />
                      ...
                      <div
                        ...
                        style={{ fontSize: "60px", paddingLeft: "70px" }}
                      >
                        <Link to={toUrl}>
              ...
              <ul className="footer-nav-link style-none train-image-text">
                {PageContent.map((val, i) => (
                  <li key={i}>
                    <div
                      onClick={() => {
                        setToUrl(val.routerPath);
                        setActiveUrl(i);
                      }}
                    >
                      <h2
                        className={
                          i === activeUrl ? "train-active" : `${val.className}`
                        }
                      >
                        {val.name}
                      </h2>
